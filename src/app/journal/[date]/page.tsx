...
import { JournalSheetReady } from "@/components/journal-sheet-ready";
...
export default async function JournalDatePage({ params }: Props) {
  ...
  return (
    <main className="min-h-screen bg-theme-bg px-5 py-10">
      <JournalSheetReady date={date}>
        <div className="journal-sheet mx-auto max-w-2xl p-6">
          <JournalEditor
            key={date}
